...
const translations: Translations = {
	...
	panelDescription: { en: "Manage your personal anime collection, track episodes, and rate your favorites", es: "Gestiona tu colección personal de anime, rastrea episodios y califica tus favoritos" },
